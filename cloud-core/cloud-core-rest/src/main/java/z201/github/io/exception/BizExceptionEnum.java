...
public enum BizExceptionEnum {
     ...
     * 错误的请求
     */
    MENU_PCODE_COINCIDENCE(400 , "菜单编号和副编号不能一致"), EXISTED_THE_MENU(400 , "菜单编号重复，不能添加"), DICT_MUST_BE_NUMBER(400 , "字典的值必须为数字"), REQUEST_NULL(400 , "请求有错误"), DATA_NULL(400 , "该数据不存在"), REPEATING_DATA(400 , "数据已经存在"), SESSION_TIMEOUT(400 , "会话超时"), SERVER_ERROR(500 , "服务器异常");
